...
class Preprocessor:
    ...
    def feature_process(self, env_obs, last_action):
        ...
        tracked_treasures = self._update_and_rank_treasures(treasures, hero_pos)
        treasure_layer, nearest_treasure_dist = self._entity_layer(tracked_treasures, hero_pos, decay=0.0)
    ...
    def get_last_feature_debug(self):
        return dict(self.last_feature_debug)

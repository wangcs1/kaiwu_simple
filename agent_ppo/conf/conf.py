...
class Config:
    ...
    REWARD_TREASURE_PROGRESS_BASE = 0.04
    REWARD_TREASURE_PROGRESS_SAFE_GAIN = 0.14
    REWARD_TREASURE_NEAR_PROGRESS = 0.32
    REWARD_TREASURE_NEAR_BONUS = 0.10
    REWARD_TREASURE_PICKUP = 1.6
